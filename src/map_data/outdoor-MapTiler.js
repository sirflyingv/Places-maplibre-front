export const styleMT = JSON.stringify({
  version: 8,
  id: 'outdoor',
  name: 'Outdoor',
  sources: {
    outdoor: {
      url: 'https://api.maptiler.com/tiles/outdoor/tiles.json?key=3eXZ5tYBKESvX6pgBzUi',
      type: 'vector',
    },
    contours: {
      url: 'https://api.maptiler.com/tiles/contours/tiles.json?key=3eXZ5tYBKESvX6pgBzUi',
      type: 'vector',
    },
    'terrain-rgb': {
      url: 'https://api.maptiler.com/tiles/terrain-rgb-v2/tiles.json?key=3eXZ5tYBKESvX6pgBzUi',
      tileSize: 512,
      type: 'raster-dem',
    },
    // 'amazon-terrain': {
  ...
  glyphs:
    'https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=3eXZ5tYBKESvX6pgBzUi',
